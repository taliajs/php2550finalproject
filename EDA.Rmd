...
As we move further along in the project, we may choose to focus on a subset of the isolates based on their isolation source. Although this information is accessible, the variable contains 821 unique categories, so analysis of source type will require grouping these categories.


\newpage
# References
1. The NCBI Pathogen Detection Project [Internet]. Bethesda (MD): National Library of Medicine (US), National Center for Biotechnology Information. 2016 May [cited YYYY MMM DD]. Available from: https://www.ncbi.nlm.nih.gov/pathogens/
